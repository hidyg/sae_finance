...
class sent_Dataset_general(torch.utils.data.Dataset):
    ...
    def __init__(self,
                 ...
                 X_names : List[str] = ['revenues_ESS', 'security_ESS', 'social-relations_ESS',
                            'crime_ESS', 'domestic-product_ESS', 'earnings_ESS',
                            'economic-union_ESS', 'elections_ESS', 'employment_ESS',
                            'equity-actions_ESS', 'exploration_ESS', 'foreign-exchange_ESS',
                            'foreign-relations_ESS', 'government_ESS', 'health_ESS', 'housing_ESS',
                            'industrial-accidents_ESS', 'insider-trading_ESS', 'interest-rates_ESS',
                            'inventory_ESS', 'labor-issues_ESS', 'legal_ESS', 'marketing_ESS',
                            'migration_ESS', 'natural-disasters_ESS', 'partnerships_ESS',
